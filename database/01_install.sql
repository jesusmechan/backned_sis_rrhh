...
CREATE UNIQUE INDEX uq_contrato_empleado_vigente
    ON contrato (id_empleado)
    WHERE estado = 'VIGENTE';

COMMENT ON TABLE contrato IS
    'Vínculo laboral vigente: colaborador o practicante, con horario y fechas para acumular vacaciones (1.5 días/mes).';
...
CREATE TABLE notificacion (
    ...
    fecha_creacion  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT ck_notificacion_tipo CHECK (tipo IN ('BANDEJA', 'APROBADA', 'RECHAZADA'))
);

CREATE INDEX ix_notificacion_usuario ON notificacion (id_usuario, leida, fecha_creacion DESC);
...
INSERT INTO horario_laboral (nombre, hora_ingreso, hora_salida, minutos_refrigerio) VALUES
    ...
    ('Jornada de prácticas', '09:00', '14:00', 0);
